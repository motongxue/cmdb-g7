...
const (
	Service_CreateTask_FullMethodName   = "/course.cmdb.task.Service/CreateTask"
	Service_QueryTask_FullMethodName    = "/course.cmdb.task.Service/QueryTask"
	Service_DescribeTask_FullMethodName = "/course.cmdb.task.Service/DescribeTask"
)
